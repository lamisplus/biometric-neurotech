package com.lamisplus.lamisplusbiometric.web;

import com.lamisplus.lamisplusbiometric.model.Biometric;
import com.lamisplus.lamisplusbiometric.model.BiometricResult;
import com.lamisplus.lamisplusbiometric.model.BiometricTemplate;
import com.lamisplus.lamisplusbiometric.model.Device;
import com.lamisplus.lamisplusbiometric.util.LibraryManager;
...
public class BiometricResource {
    ...
    public BiometricResult identify(@RequestParam String reader, @RequestParam String accessToken, @RequestParam String server, @RequestBody Biometric biometric) {
        ...
        if (status.equals(NBiometricStatus.OK)) {
            ...
            if (status.equals(NBiometricStatus.OK)) {
                ...
                if (biometric == null || biometric.getTemplates() == null || biometric
                        .getTemplates()
                        .isEmpty()) {
                ...
                if (task
                    ...
                    if (status.equals(NBiometricStatus.OK)) {
                        ...
                        byte[] isoTemplate = subject
                                .getTemplateBuffer(CBEFFBiometricOrganizations.ISO_IEC_JTC_1_SC_37_BIOMETRICS,
    ...
    @PostMapping("/enrol")
    public BiometricResult enrol(@RequestParam String reader, @RequestParam String server, @RequestParam String accessToken, @RequestBody Biometric biometric) {
        try {
    ...
    private List<BiometricTemplate> biometricTemplates(String server, String accessToken) {
        ...
        ResponseEntity<List<BiometricTemplate>> response = restTemplate.exchange(RequestEntity
                                                                                         .get(new URI(url))
